          ...
          await MovimentoCaixa.create(
            {
              ...
              valor: ((entry[1].totalReceb - entry[1].totalDesp) * -1) / 100,
              saldo: ((entry[1].totalReceb - entry[1].totalDesp) * -1) / 100,
              dtVenc: nextMonth,
              status: 1,
              ano: fechamento.ano,
              periodo: periodMonth,
      ...
      await MovimentoCaixa.create(
        {
          ...
          valor: desp.total / -100,
          saldo: desp.total / -100,
          dtVenc: nextMonth,
          status: 1,
          ano: fechamento.ano,
          periodo: periodMonth,
          ...
          await MovimentoCaixa.create(
            {
              ...
              ColabCreate: 1,
              ColabPgmto: colabId,
              valor: ((saldoHrs / 60) * compRec[i].colabVlrHr * -1) / 100,
              saldo: ((saldoHrs / 60) * compRec[i].colabVlrHr * -1) / 100,
              dtVenc: nextMonth,
              status: 1,
              ano: fechamento.ano,
              periodo: periodMonth,

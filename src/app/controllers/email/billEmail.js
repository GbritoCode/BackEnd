export default function generateBillEmail(data) {
            ...
            <tbody>
                <tr>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="860" style="border: 1px solid #cccccc; border-collapse: collapse;">
                        <tbody>
                            <tr>
                                <td align="center" style="color: #0071bc; font-size: 40px; font-weight: bold; font-family: Segoe UI Light; background-color: #0071bc; height: 60px;">
                            ...
                            <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <span style="font-size: 24px;">
                                                <strong><span style="font-size: 35px; color: #333333;">FATURAMENTO </span> <br/>DE SERVIÇOS</strong></span>
                                            </td>
                                            <td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="color: #595959; font-family: Segoe UI Light; background-color: #ffffff; width: 960px; height: 30px; text-align: center;"><span style="font-size: 15px;">Prezado Cliente, segue anexo nossa nota fiscal de servi&ccedil;os relacionada ao projeto detalhado a seguir. Pedimos que envie a mesma para procedimentos de recebimento e pagamento. Para mais detalhes entre em contato conosco.</span><br />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <table style="solid #cccccc; border-image: none; width: 100%;" cellspacing="0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="color: #153643; line-height: 20px; font-family: Segoe UI Light; font-size: 14px; background-color: #d8d8d8;"><span style="font-size: 14px; background-color: #d8d8d8; font-family: Segoe UI Light; color: #153643;">&nbsp;Parcela</span></td>
                                                                    <td style="color: #153643; line-height: 20px; font-family: Segoe UI Light; font-size: 14px; background-color: #d8d8d8;" colspan="3">
                                                                    <span style="font-size: 14px; background-color: #d8d8d8; font-family: Segoe UI Light; color: #153643;">${data.parcelasOport}</span></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="color: #153643; line-height: 20px; font-family: Segoe UI Light; font-size: 14px; background-color: #d8d8d8;">&nbsp;Data Vencimento</td>
                                                                    <td style="color: #153643; line-height: 20px; font-family: Segoe UI Light; font-size: 14px; background-color: #d8d8d8;" colspan="3">${data.dtVencParcela}<br />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="color: #153643; line-height: 20px; font-family: Segoe UI Light; font-size: 14px; background-color: #d8d8d8;">&nbsp;Pedido</td>
                                                                    <td style="color: #153643; line-height: 20px; font-family: Segoe UI Light; font-size: 14px; background-color: #d8d8d8;" colspan="3">${data.pedidoCliOport}<br />
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center">
                                                                                <img alt="" src="https://www.aidera.com.br/yl/wp-content/uploads/2018/08/calendario.png"  style="display: block;" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="padding: 15px 0px 0px; color: #153643; font-family: Segoe UI Light; font-size: 14px; line-height: 20px; text-align: center;">
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center">
                                                                                <img alt="" src="https://www.aidera.com.br/yl/wp-content/uploads/2018/08/novo.png"  style="display: block;" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="padding: 15px 0px 0px; color: #153643; font-family: Segoe UI Light; font-size: 14px; line-height: 20px; text-align: center;">
                                                                                <span style="background-color: #ffffff; font-family: Segoe UI Light; font-size: 14px; color: #153643;">Quer acelerar seu processo de cota&ccedil;&otilde;es e&nbsp; mant&ecirc;-los&nbsp; sempre audit&aacute;veis? N&atilde;o desperdice seu tempo com controles ineficientes. Com IBID seus fornecedores respondem as cota&ccedil;&otilde;es direto na web e o seu comprador tem todas as rotinas de compras gerenciadas pelo portal. Fale com a gente!</span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    </td>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <img width="24" height="24" style="display: block; border-width: 0px; border-style: solid;" alt="Instagram" src="https://oktobarbike.com.br/wp-content/uploads/2016/08/instagram-icon.png" />
                                                                    </a>
                                                                    </td>
                                                                    <td style="color: #0071bc; width: 20px;">|</td>
                                                                    <td style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;">
